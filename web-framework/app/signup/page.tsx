...
import { Leaf, Shield, User, Mail, Lock, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50/40 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative flex items-center justify-center mt-0.5">
                <input
                  ...
                  className="w-5 h-5 rounded border-2 border-gray-300 text-emerald-600 focus:ring-emerald-500 focus:ring-offset-0 cursor-pointer"
                />
              </div>
        ...
        {/* Privacy Badge */}
        <div className="bg-gradient-to-r from-emerald-50 to-emerald-100/50 border-2 border-emerald-200 rounded-xl p-4 mt-6 flex gap-3 items-start shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-emerald-700 leading-relaxed">
              Track AI usage responsibly. No prompts are stored, ever.
            </p>
          </div>
        </div>
